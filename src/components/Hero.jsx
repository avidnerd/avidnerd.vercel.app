    ...
    <section className={`relative w-full h-screen mx-auto`}>
      ...
      >
        <a
          ...
          className="flex items-center gap-2 bg-[#1DB954] hover:bg-[#1ed760] rounded-full px-4 py-2 shadow-lg hover:shadow-xl transition-all duration-300 group"
        >
          <svg
      ...
      >
        ...
        <div>
          ...
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            I'm a high schooler who is a machine learning research enthusiast interested in tech.<br className='sm:block hidden' />
          </p>
        </div>
      </div>
