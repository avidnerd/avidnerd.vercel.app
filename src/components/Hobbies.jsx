      ...
      <div className="relative max-w-2xl" style={{ transform: `scale(${scale})`, transformOrigin: 'top left' }}>
        ...
        <div className="relative w-full">
          ...
          */}
          ...
          <button
            onClick={prevVideo}
            className="absolute bottom-[15%] left-[5%] w-[200px] h-[200px] hover:scale-110 transition-transform cursor-pointer z-10"
          ...
          <button
            onClick={nextVideo}
            className="absolute bottom-[15%] right-[5%] w-[200px] h-[200px] hover:scale-110 transition-transform cursor-pointer z-10"
