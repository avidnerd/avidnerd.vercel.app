...
export const facets = [
  ...
  },
  {
    ...
    label: "values",
    title: "My Philosophy",
    text: "I believe that everyone has a duty to help as many other people as they can. I am particularly interested in effective altruism (I run the Duke Effective Altruism Club)! A quote I frequently admire is 'I cannot do all the good that the world needs; but the world needs all the good that I can do.'",
  },
  {
    id: "research",
    color: "#0f7d6b",
  ...
  },
  {
    ...
    label: "photography",
    title: "Views",
    text: "I am a sunset FIEND and a general lover of all things beautiful in nature. here are some cool flicks i've taken over the years :)",
    photos: [
      { src: "/img/hobbies/sunrise-train.jpg", cap: "the 6am train, pink the whole way" },
      { src: "/img/hobbies/rainbow.jpg", cap: "rainbow OVER MY HOUSE OH MY DAYS" },
      { src: "/img/hobbies/lbi-dawn.jpg", cap: "long beach island!!" },
      { src: "/img/hobbies/dream-sunset.jpg", cap: "sunset over the american dream mall" },
      { src: "/img/hobbies/ocean-sunset.jpg", cap: "beach sunrise :))))" },
      { src: "/img/hobbies/marina-sunset.jpg", cap: "golden hour before my senior cruise" },
      { src: "/img/hobbies/city-dusk.jpg", cap: "twin peaks, san francisco for YC startup school" },
      { src: "/img/hobbies/purple-sky.jpg", cap: "duke sunset <3" },
    ],
  },
  {
    id: "outdoors",
    ...
    label: "nature",
    title: "Hiking",
    text: "I've recently got into hiking this past summer, these are some pretty cool views I've seen so far, but there's more to come in North Carolina!",
    photos: [
      ...
      { src: "/img/hobbies/lake-overlook.jpg", cap: "wyanokie high point" },
      { src: "/img/hobbies/valley-overlook.jpg", cap: "allamuchy state park" },
      { src: "/img/hobbies/sutro-cliffs.jpg", cap: "cliffs at lands end, san francisco" },
      { src: "/img/hobbies/trail-bridge.jpg", cap: "eagle rock reservation" },
      { src: "/img/hobbies/grass-trail.jpg", cap: "lewis morris county park" },
    ],
  },
  {
    id: "oboe",
    ...
    icon: "Music",
    label: "oboe",
    title: "Oboe and Music",
    text: "I have played the oboe for six years and have enjoyed participating in multiple ensembles across the years. I also have a youtube channel where I occasionally post covers, check them out @subhi_k_steph!",
    photos: [
  ...
  },
  {
    ...
    label: "building",
    title: "Making things!",
    text: "I came into Duke as a CS major and mainly had a software background. Since I have been an engineer, I have come to learn how to build my own physical products vis CAD. Below are some of the projects I've made so far.",
    photos: [
  ...
  },
  {
    ...
    label: "food",
    title: "Food :)",
    text: "I took up the hobby of cafe-hopping and trying new restaurants about a year ago. Since then, I've tried over 100 new restaurants/cafes and enjoy writing reviews on my Beli (drop a follow @subhiii)! My favorite thing to try is matcha :). Here are some of my top-ranked eats!",
    photos: [
